...
function get20s(array) {
  ...
  for(let i in array){
    ...
    if(Number(years[0]) >= 1900 && Number(years[2]) <= 2000)
...
console.log(addArtist(artists, 20, 'Markeisha', '1994-2021', 'Web Development', 'American', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'));
...
function lotsOfArt(array) {
  const hundredsOfPaintings = [];
  for(let i = 0; i < array.length; i++){
    if(array[i]["paintings"] >= 100){
      hundredsOfPaintings.push(array[i]["name"]);
    }
  }
  return hundredsOfPaintings
}
